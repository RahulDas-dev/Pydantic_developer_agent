...
from lib.configs.main import AgentConfig
...
def build_agent_from_config(config: AgentConfig) -> Agent[AgentContext, str | Failure]:
    """
    Build an agent from the provided configuration.
    """
